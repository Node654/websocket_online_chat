        ...
        <div class="flex items-start">
            <div class="w-1/2 border border-gray-400 p-4 mr-4 bg-white">
                ...
                <div v-if="props.chats">
                    <div v-for="chat in props.chats" class="mb-4 p-4 flex items-center justify-between border-b border-gray-400">
                        ...
                        <div v-if="chat.readableMessageCount !== 0">
                            <p class="bg-sky-500 p-1 rounded-full text-white">{{ chat.readableMessageCount }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-1/2 border border-gray-400 p-4 bg-white">
                <div class="flex justify-between">
                    ...
                    <button v-if="!isGroup" @click.prevent="isGroup = true" class="text-white bg-indigo-500 rounded-full p-2 hover:bg-amber-600">Make group</button>
                    <div v-if="isGroup">
                        ...
                        <button v-if="isGroup" @click.prevent="refreshUserIds" class="text-white bg-indigo-500 rounded-lg p-3 hover:bg-amber-600">X</button>
                    </div>
                </div>
                <div v-if="props.users">
                    <div v-for="user in props.users" class="mb-4 p-4 flex items-center justify-between border-b border-gray-400">
